  ...
  return (
    <>
          ...
          <tbody>
            {stats.daily.map((d) => (
              ...
              >
                ...
                <td className="px-3 py-2 text-right text-xs text-emerald-800">
                  {d.seenCount}
                </td>
                <td className="px-3 py-2 text-right text-xs text-rose-800">
                  {d.noShowCount}
                </td>
      ...
      {stats.weekly.length > 0 && (
        <div className="mt-6">
          <h3 className="text-base font-medium text-slate-900">Vue hebdomadaire</h3>
          <p className="mt-1 text-sm text-slate-600">
