...
export function SummaryPanel({ stats, loading, period, onPeriodChange }: SummaryPanelProps) {
  return (
    <section className="rounded-2xl bg-white/90 p-6 shadow-sm ring-1 ring-rose-100/80 backdrop-blur">
      <div className="flex items-center justify-between gap-3">
        <h2 className="text-xl font-semibold text-slate-900">Synthèse rapide</h2>
        <div className="flex items-center gap-1.5 rounded-full bg-rose-50 px-1.5 py-1.5 text-sm text-slate-700">
          <button
            type="button"
      ...
      {loading ? (
        ...
        <>
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            <div className="rounded-xl bg-rose-50 px-3.5 py-3.5">
            ...
            <div className="rounded-xl bg-amber-50 px-3.5 py-3.5">
              <p className="text-sm font-medium text-amber-700">Taux de no-show</p>
            ...
            <div className="rounded-xl bg-emerald-50 px-3.5 py-3.5">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-rose-100 bg-rose-50/60 px-3.5 py-3.5">
            ...
            <div className="rounded-xl border border-emerald-100 bg-emerald-50/60 px-3.5 py-3.5">
              <p className="text-sm font-medium text-slate-700">
